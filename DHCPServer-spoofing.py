...
src_addr = b'\x01\x02\x03\x04\x05\x06'#deverá vir da requisição
dst_addr = b'\xff\xff\xff\xff\xff\xff'#deverá vir da requisição
ethertype = b'\x08\x00'
...
checksum = b'\xa9\xfc' #random
source_address= b'\x00\x00\x00\x00'
...
print('DHCP len', len(dhcp_packet))
