...
def application_protocol_head(application_protocol, data):
    ...
    if (application_protocol == 'DHCP'): #DNS Header format 16 bit per line (2 bytes)
        ...
        print("Transation ID: ", transation_id)
        print("Client MAC: ", show_mac(client_mac[0]))#precisa o [0] pois em casos simples retorna tupla
        print("Magic Cookie: ",magic_cookie)
